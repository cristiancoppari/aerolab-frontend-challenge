      ...
      <div className="relative" ref={wrapperRef}>
        <div className="relative">
          ...
          <input
            ...
            className={cn(
              "h-10 w-full rounded-[1.25rem] border border-brand-pink-600/40 bg-white pl-10 pr-8 shadow-brand-pink-100 placeholder:text-brand-pink-200 focus:outline-none focus:ring-0 [&::-webkit-search-cancel-button]:hidden",
